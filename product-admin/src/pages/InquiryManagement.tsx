    ...
    <div className="inquiries-page animate-fade-in">
                ...
                <div key={iq.id} className="product-item-card inquiry-card glass-panel" onClick={() => setSelectedInquiry(iq)}>
                  ...
                  <div className="col-type">
                     <span className={`category-pill ${iq.type}`}>
                       {iq.type === 'technical' ? 'Technical Inquiry' : 'Sales Inquiry'}
                     </span>
                  </div>
      ...
      {selectedInquiry && (
        <div className="modal-overlay" onClick={() => setSelectedInquiry(null)}>
          <div className="detail-modal inquiry-detail glass-panel" onClick={e => e.stopPropagation()}>
             ...
             <div className="detail-body">
                <div className="detail-top">
                  <div>
                    <span className={`badge ${selectedInquiry.type}`}>
                      {selectedInquiry.type === 'technical' ? 'Technical Support' : 'Sales & Information'}
                    </span>
                ...
                <div className="modal-footer-actions">
                   ...
                   <a href={`mailto:${selectedInquiry.email}?subject=Re: ${selectedInquiry.type === 'technical' ? selectedInquiry.subject : 'Product Inquiry'}`} className="btn-primary">
                     <Mail size={18} />
                     Reply via Email
                   </a>
                </div>
